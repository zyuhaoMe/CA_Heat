// this file stores functions relative to Gaussian-Legendre integration
...
double computeThermalFieldWithGaussianLegendre(
    ...
    // determines the Gauss-Legendre abscissae and weights necessary for an n-point fixed order integration scheme
...
// evaluate the numerical integration by summing wi*f(xi) over i for each point of interest during cooling time
