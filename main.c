...
int main(int argc, char *argv[]) {
    ...
    double timeTotal = 1.2 * cycleTime; // total range of time of interest
    ...
    Vy = 2 * PI * spiralRadius / cycleTime;
...
//    }
    ...
    double laserTime = cycleTime; // time range when the heat source is on
